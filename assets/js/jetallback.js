...
(function () {
  ...
  var _moduleList = ['render-time','router', 'css-config', 'res', 'valid', 'lang', 'module','tool','jui'];
  ...
  Jet.$use = function () {
    ...
    if(list[8]=='jui'&&_isUd(list[7])){
      list[7]='tool';
      _info('jui 依赖 tool,已自动添加依赖')
    }
